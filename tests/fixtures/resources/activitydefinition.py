...
class ActivityDefinition(domainresource.DomainResource):
    ...
    observationRequirement: typing.List[typing.Optional[fhirtypes.CanonicalType]] = (
        Field(
            None,
    ...
    specimenRequirement: typing.List[typing.Optional[fhirtypes.CanonicalType]] = Field(
        None,
    ...
    subjectCanonical: fhirtypes.CanonicalType = Field(
        None,
